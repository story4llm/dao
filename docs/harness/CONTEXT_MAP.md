...
| 任务类型 | 追加读取 | 通常需要更新 |
|---|---|---|
| 产品范围、用户输出 | `docs/product/vision.md`、`docs/product/prd-v0.2.md`、研究报告第四/五阶段 | 产品文档、项目状态、必要的 ADR |
...
| 每日趋势认知 | `prompts/daily-cognition-run-v0.3.md`、数据源资格矩阵 v0.2、评估契约 v0.3、八类输出 schema、上一帧 | run manifest、Evidence Manifest、Feature、Baseline、Evidence、MCF、Forecast、Delta、解释 |
